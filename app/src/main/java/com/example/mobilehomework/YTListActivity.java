...
public class YTListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ytlist);


        selectFood = findViewById(R.id.select_yt);

        zklist = findViewById(R.id.yt3_list);

        MyDataBaseHelper dbHelper = new MyDataBaseHelper(YTListActivity.this, "jibu_db",null,1);
        db = dbHelper.getWritableDatabase();
        selectFood.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Cursor cursor = db.query("ytp", null, null, null,
                        null, null, null);
                ...
                for(Food f:foodList)
                {
                    ...
                    TextView tv=new TextView(YTListActivity.this);
                    //2.把人物的信息设置为文本的内容
        ...
        zklist.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(YTListActivity.this,MJLListActivity.class);
                startActivity(i);
            }
        });
    }
